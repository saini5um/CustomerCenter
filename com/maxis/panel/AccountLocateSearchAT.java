 ...
 * @author  brot01
 */
public class AccountLocateSearchAT extends AbstractHTMLPanel implements ICSGFilterCard, ContextFormListener {
                ...
                if (ctx != null) {
                    ...
                    if (index >= 0) {
                        ...
                        if (account.getAttributeData("InUse") != null) {
                            JOptionPane.showMessageDialog(this, ResourceManager.getString("AccountLocateSearch.text.AccountInUse") );
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        lblBillFname = new com.csgsystems.igpa.controls.CSGLabel();
        ...
        edtBillFname = new com.csgsystems.igpa.controls.CSGEdit();
        ...
        jSplitPane1.setMinimumSize(new java.awt.Dimension(850, 440));
        jSplitPane1.setPreferredSize(new java.awt.Dimension(850, 440));
        ...
        lblAccountExternalId.setBounds(3, 3, 152, 20);

        lblBillFname.setLocalizationKey("AccountLocate.label.BillFname");
        lblBillFname.setMinimumSize(new java.awt.Dimension(140, 20));
        jPanel1.add(lblBillFname);
        lblBillFname.setBounds(3, 29, 152, 20);
        ...
        lblBillLname.setBounds(3, 55, 152, 20);
        ...
        lblBillCompany.setBounds(3, 81, 152, 20);
        ...
        lblCustPhone1.setBounds(3, 107, 152, 20);
        ...
        lblCustPhone2.setBounds(3, 133, 152, 20);
        ...
        lblAccountExternalIdType.setBounds(3, 159, 152, 20);
        ...
        lblServiceExternalIdType.setBounds(3, 211, 152, 20);
        ...
        lblServiceExternalId.setBounds(3, 237, 152, 20);
        ...
        lblOrderNumber.setBounds(3, 289, 152, 20);
        ...
        edtAccountExternalId.setBounds(161, 3, 152, 20);

        edtBillFname.setAttributeName("BillFnameFind");
        edtBillFname.setDomainName("AccountLocateList");
        edtBillFname.setMinimumSize(new java.awt.Dimension(140, 20));
        jPanel1.add(edtBillFname);
        edtBillFname.setBounds(161, 29, 152, 20);
        ...
        edtBillLname.setBounds(161, 55, 152, 20);
        ...
        edtBillCompany.setBounds(161, 81, 152, 20);
        ...
        edtCustPhone1.setBounds(161, 107, 152, 20);
        ...
        edtCustPhone2.setBounds(161, 133, 152, 20);
        ...
        cbAccountExternalIdType.setBounds(161, 159, 152, 20);
        ...
        cbServiceExternalIdType.setBounds(161, 211, 152, 20);
        ...
        edtServiceExternalId.setBounds(161, 237, 152, 20);
        ...
        edtOrderNumber.setBounds(161, 289, 152, 20);
        ...
        add(jSplitPane1);
        jSplitPane1.setBounds(0, 0, 752, 440);
    ...
    private com.csgsystems.igpa.controls.CSGEdit edtBillFname;
    ...
    private com.csgsystems.igpa.controls.CSGLabel lblBillFname;
